...
export const POSITION_FREE = "FREE";
export const POSITION_BOOKED = "BOOKED";
export const POSITION_SELECTED = "SELECTED";

export const BOOKING_REQUEST_SUCCESS = "BOOKING_REQUEST_SUCCESS";
export const BOOKING_REQUEST_ERROR = "BOOKING_REQUEST_ERROR";

export const BOOKING_RESPONSE_RECEIVED = "BOOKING_RESPONSE_RECEIVED";
